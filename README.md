...
MIABIS is made up of different entities, modelling a different biobanking-related entity (e.g. a biobank, a sample). These entities consist of several attributes, each of which describes an aspect of the entity. An overview of the different attributes and the relations between them is shown in the diagram below.
