...
| MIABIS-SAMPLE-03 | Sample storage temperature | The long-term temperature at which the sample is stored after preparation, based on SPREC v4 | Enumerated Value | storageTemperature | Storage Temperature |
...
| MIABIS Attribute Code | MIABIS Attribute Name | SPREC Code | SPREC V4 Sample Type | SCT Code | SCT Sample Type | bbmri.de Code | Lens Display |
| --- | --- | --- | --- | --- | --- | --- | --- |
